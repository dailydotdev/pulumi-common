...
export declare function createServiceAccountAndGrantRoles(resourceName: string, baseName: string, serviceAccountId: string, roles: IAMRole[], isAdhocEnv?: boolean): {
